        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            for pt in &self.shapes.points {
                painter.rect(egui::Rect {
                    min: o + Vec2::new(pt.x.value-3., pt.y.value-3.),
                    max: o + Vec2::new(pt.x.value+3., pt.y.value+3.)
            ...
            for Segment { a, b } in &self.shapes.segments {
                ...
                painter.line_segment([o + Vec2::new(pt1.x.value, pt1.y.value), o + Vec2::new(pt2.x.value, pt2.y.value)], stroke.clone());
            }
            ...
            for Circle { radius, origin } in &self.shapes.circles {
                ...
                painter.circle_stroke(o + Vec2 { x: origin.x.value, y: origin.y.value }, radius.value, stroke.clone());
            }
